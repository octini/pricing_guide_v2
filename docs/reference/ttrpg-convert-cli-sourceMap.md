<!--
Reference copy of ebullient/ttrpg-convert-cli docs/sourceMap.md.
Upstream URL: https://raw.githubusercontent.com/ebullient/ttrpg-convert-cli/main/docs/sourceMap.md
Retrieval date: 2026-07-14
Reference only: this file is for source display-name cross-reference and does not create a runtime dependency on ttrpg-convert-cli.
-->
